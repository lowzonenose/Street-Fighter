...
#------------------------------------------------------- ACTION DU JOUEUR ----------------------------------------------------------------------------------------------------
	...
	def blocking_up(self):
		if self.last_direction == "right":
			self.image_active = self.image_perso["r_blocking"]
			self.nom_image_active = "r_blocking"
		else:
			self.image_active = self.image_perso["l_blocking"]
			self.nom_image_active = "l_blocking"
		self.placer_rect()


	def blocking_down(self):
		if self.last_direction == "right":
