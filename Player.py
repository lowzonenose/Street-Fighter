...
class Player:
	...
	def charger_images(self):
		...
		self.image_perso["r_walking_right"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/walking_right.png").convert_alpha()
		self.image_perso["r_jump_up"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/jump_up.png").convert_alpha()
		self.image_perso["r_jump_down"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/jump_down.png").convert_alpha()
		self.image_perso["r_crouch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/crouch.png").convert_alpha()
		self.image_perso["r_h_punch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/h_punch.png").convert_alpha()
		self.image_perso["r_jump_punch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/jump_punch.png").convert_alpha()
		self.image_perso["r_crouch_l_punch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/crouch_l_punch.png").convert_alpha()
		self.image_perso["r_l_kick"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/l_kick.png").convert_alpha()
		self.image_perso["r_crouch_h_kick"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/crouch_h_kick.png").convert_alpha()
		self.image_perso["r_jump_l_kick"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/jump_l_kick.png").convert_alpha()
		self.image_perso["r_blocking_up"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/blocking_up.png").convert_alpha()
		self.image_perso["r_blocking_crouch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_right/blocking_crouch.png").convert_alpha()

		self.image_perso["l_idle"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/idle.png").convert_alpha()
		self.image_perso["l_walking_left"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/walking_left.png").convert_alpha()
		self.image_perso["l_walking_right"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/walking_right.png").convert_alpha()
		self.image_perso["l_jump_up"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/jump_up.png").convert_alpha()
		self.image_perso["l_jump_down"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/jump_down.png").convert_alpha()
		self.image_perso["l_crouch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/crouch.png").convert_alpha()
		self.image_perso["l_h_punch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/h_punch.png").convert_alpha()
		self.image_perso["l_jump_punch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/jump_punch.png").convert_alpha()
		self.image_perso["l_crouch_l_punch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/crouch_l_punch.png").convert_alpha()
		self.image_perso["l_l_kick"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/l_kick.png").convert_alpha()
		self.image_perso["l_crouch_h_kick"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/crouch_h_kick.png").convert_alpha()
		self.image_perso["l_jump_l_kick"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/jump_l_kick.png").convert_alpha()
		self.image_perso["l_blocking_up"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/blocking_up.png").convert_alpha()
		self.image_perso["l_blocking_crouch"] = pygame.image.load("image/" + self.nom + "/" + self.nom + "_left/blocking_crouch.png").convert_alpha()

		self.logo = pygame.transform.scale(pygame.image.load("image/" + self.nom + "/" + self.nom + ".png").convert_alpha(), (140, 180))
